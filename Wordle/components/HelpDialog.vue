<template>
    <v-dialog v-model="modelValue" max-width="500">
      <v-card style="background-color: myFunction()" color = "secondary">
        ...
        <v-card-text class="font" style="text-align: center; font-size: medium">
          <header class="font">Guess the Wordle in 6 tries.</header>
        </v-card-text>
        ...
        <v-card-text class="font" style="text-align: center">
        ...
        <v-card-item>
          <v-card-text style="text-align: center">
            <header class="font">Color Codes</header>
          </v-card-text>
